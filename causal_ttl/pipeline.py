...
from .adapters import HeuristicCloudDiagnoser, MockEdgeReasoner
from .clustering import cluster_reasoning_paths
from .config import PipelineConfig
from .schema import Diagnosis, MedSample, SampleRunResult
from .text_utils import answer_score
from .ttl import evaluate_interventions
...
class CausalTTLPipeline:
    ...
    def run_sample(self, sample: MedSample) -> SampleRunResult:
    ...
    def run_dataset(self, samples: list[MedSample]) -> list[SampleRunResult]:
